      ...
      <div className="w-full max-w-md">
        <Card className="backdrop-blur-sm bg-white/80 shadow-xl border-0 ring-1 ring-gray-200/50">
          <CardHeader className="text-center pb-4">
            <CardTitle className={`text-4xl font-bold bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent transition-all duration-500 ${isAnimating ? 'scale-110' : 'scale-100'}`}>
              {getGreetingMessage()}
            </CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="text-center space-y-4">
              ...
              <div className="p-4 bg-gradient-to-r from-red-50 to-rose-50 rounded-lg border border-gray-200">
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 transition-all duration-300 transform hover:scale-105"
                size="lg"
              >
